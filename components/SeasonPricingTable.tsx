      ...
      {open && (
        <div className="unit-card__body">
          <div className="unit-card__body-inner">
            ...
            {unit.promoCode && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap', background: '#fff5f5', border: '1px dashed #c0392b', borderRadius: '4px', padding: '1rem 1.25rem', marginBottom: '1.25rem' }}>
